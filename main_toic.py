                ...
                for prod_setting in [1, 2]:
                    for prod_setting2 in [1, 2, 3]:
                        ...
                        for bud in range(1, total_budget + 1):
                            ...
                            ssto_main = SeedSelectionTO(graph_dict, seed_cost_dict, product_list, bud, pps, wpiwp)
                            ...
                            top_order_list = ssto_main.insertExpectProfitOrder(top_order_list, [set() for _ in range(num_product)], copy.deepcopy(wallet_list), copy.deepcopy(personal_prob_list))
                            ...
                            for sample_count in range(sample_number):
                                ...
                                if (sample_count + 1) % sample_output_number == 0:
                                    ...
                                    if not os.path.isdir(path1):
                                        os.mkdir(path1)
                                    path = "result/mtoic_pps" + str(pps) + "_wpiwp" * wpiwp + "/" +\
